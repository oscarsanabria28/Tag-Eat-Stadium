			...
			<div class="col-md-6 col-md-offset-3">
				<div class="jumbotron">
					<div class="card card-container">
			            ...
			            <img id="profile-img" class="profile-img-card img-thumbnail" src="images/tap.png" />
			            <p id="profile-name" class="profile-name-card"></p>
			            <form class="form-signin" action="postUser" method="POST">
			            	<p>${shittymessage}</p>
			                <span id="reauth-email" class="reauth-email"></span>
			                <input type="text" id="email" name="email" class="form-control" placeholder="Email" required autofocus style="margin-bottom:5px">
